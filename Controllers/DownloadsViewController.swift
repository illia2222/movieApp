...
class DownloadsViewController: UIViewController {
    ...
    private var titles: [TitleItemDownload] = [TitleItemDownload]()
    ...
    private func fetchLocalStorageForDownload() {
        DataPersistanceManager.shared.fetchingDownloadTitleFromDatabase { [weak self] result in
            switch result {
...
extension DownloadsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        switch editingStyle {
        case .delete:
            DataPersistanceManager.shared.deleteDownloadTitleFromDatabaseWith(with: titles[indexPath.row]) { [weak self] result in
                switch result {
